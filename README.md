...
### Phase 2: Logs (complete)
- [x] **Loki**: SingleBinary mode, local-path PV (10 Gi), 7-day retention
- [x] **Promtail** DaemonSet: cluster pod logs shipping to Loki
- [x] **Promtail** on external hosts: JBNAS01, JBVM01, JBVM02, JBVM03 — journal + syslog, pushing to NodePort 31100
