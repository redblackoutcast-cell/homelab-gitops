...
| Log shipping | Promtail (DaemonSet) | Ships all cluster pod logs to Loki; auto-discovers pods via filesystem tail on `/var/log/pods/` |
...
- [ ] **Promtail** on external hosts (NAS, jump box, operations VM)
